...
#ifndef INSTANT_TALK_WIDGET_H
#define INSTANT_TALK_WIDGET_H
...
#endif 
class InstantTalkWidget : public Gtk::VBox
			#ifndef OLDLIBGLADEMM
			, virtual public DtmfHandler 
			#endif
{
	public:
		InstantTalkWidget(  std::string callId,  std::string remoteUri, MainWindow * mw, bool incoming, std::string secure="unprotected");

		virtual ~InstantTalkWidget();
